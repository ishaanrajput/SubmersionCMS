...
<table class="table table-bordered table-striped table-hover">
  ...
  while($row = mysqli_fetch_assoc($select_comments)){
    ...
    echo "<td><a href='comments.php?approve={$comment_id}'><center><i class='fa fa-check'></i></center></a></td>";
    echo "<td><a href='comments.php?ban={$comment_id}'><center><i class='fa fa-ban'></i></center></a></td>";
    echo "<td><a href='comments.php?delete={$comment_id}'><center><i class='fa fa-trash'></i></center></a></td>";
    echo "</tr>";
